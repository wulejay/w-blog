import { version, ref, watchEffect, watch, getCurrentInstance, defineAsyncComponent, isRef, computed, defineComponent, useSlots, h, inject, unref, provide, shallowReactive, Suspense, nextTick, Transition, useSSRContext, hasInjectionContext, getCurrentScope, onScopeDispose, reactive, mergeProps, withCtx, createVNode, createApp, effectScope, toRef as toRef$1, readonly, customRef, shallowRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, isReadonly, isShallow, isReactive, toRaw, onUnmounted } from 'vue';
import { $ as $fetch, w as withQuery, l as hasProtocol, p as parseURL, m as isScriptProtocol, n as joinURL, o as sanitizeStatusCode, q as createHooks, h as createError$1, r as isSamePath, t as toRouteMatcher, v as createRouter$1 } from '../runtime.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-B0A-YfU-.mjs').then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-BwtZ8HjB.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-D1NoQkso.mjs').then((r) => r["default"] || r.default || r));
...
const sounds = {
  "/sounds/bubble.wav": {
    "src": "/sounds/bubble.wav",
    "volume": 1
  },
  "/sounds/light-off.mp3": {
    "src": "/sounds/light-off.mp3",
    "volume": 1
  },
  "/sounds/light-on.mp3": {
    "src": "/sounds/light-on.mp3",
    "volume": 1
  }
};
const sounds_7noHXeIa7n = /* @__PURE__ */ defineNuxtPlugin(() => {
  return {
    provide: {
      sounds
    }
...
const layouts = {
  default: () => import('./default-DApeivdx.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DxhM1w36.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-iDHS4pwM.mjs').then((r) => r.default || r));
...
export { useNuxtApp as a, useRuntimeConfig as b, useIntersectionObserver as c, defu as d, entry$1 as default, defuFn as e, useDark as f, useToggle as g, useRouter as h, navigateTo as i, nuxtLinkDefaults as n, useHead as u };
